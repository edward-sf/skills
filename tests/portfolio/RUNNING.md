...
2. **First turn:** write this to a message file (substitute placeholders; `<SKILL_LINE>` is empty for RED, or `Before doing anything, read <REPO>/portfolio-<name>/SKILL.md (and any files it references) and follow it exactly.` for GREEN/REFACTOR):
